...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Sndh_SetParameters ( void * iSndhTune_File , int iSndhTune_Number )
* ACTION   : Set Parameters to play music
* CREATION : 30.09.2021 Zorro2^NoExtra
*-----------------------------------------------------------------------------------*/

void Sndh_SetParameters ( void * iSndhTune_File , int iSndhTune_Number ) {
